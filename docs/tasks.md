...
- [x] T301 实现本地 ASR 适配器、健康检查和文本 Mock。
- [x] T302 实现监听、识别、解析、成功和失败状态机。
- [x] T303 实现 `/commands/parse`、本地规则和可选本地模型 provider。
- [x] T304 实现本地常用命令快速解析。
- [x] T305 实现按 ID、名称、选中和最近对象的目标解析。
- [x] T306 实现低置信度与多目标确认流程。
...
- [x] T404 实现同源素材代理和透明背景检查。
- [x] T405 实现对象重新生成且保留变换属性。
...
- [ ] T507 录制演示视频并更新最终 README 截图（截图已完成）。
