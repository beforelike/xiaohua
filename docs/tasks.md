...
- [ ] T206 实现预设草地、树、太阳和云朵素材。

## 阶段 3：语音与指令

- [ ] T301 实现 Web Speech API 适配器和能力检测。
- [ ] T302 实现监听、识别、解析、成功和失败状态机。
- [ ] T303 实现 `/commands/parse` 与模型 provider。
- [ ] T304 实现本地常用命令快速解析。
...
- [ ] T501 实现 PNG 导出并处理跨域错误。
- [ ] T502 实现版本化项目 JSON 导出与导入。
- [ ] T503 添加命令解析和状态变更单元测试集。
- [ ] T504 添加完整演示流程端到端测试。
